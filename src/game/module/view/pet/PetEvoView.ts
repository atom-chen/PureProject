...
class PetEvoView extends BaseSpriteView {
    ...
    public skill0: PetSkillItem;
    public skill1: PetSkillItem;
    public skill2: PetSkillItem;
    public skill3: PetSkillItem;
    ...
    public upCn() {
        ...
        if (petServer) {
            ...
            let digitalNext = this.selectData.advancedFactor[petServer.wStep + 1] / 10000
            let baseAttr = GlobalFun.ObjPlusRide(this.selectData.basicatt, digital);
            let nextAttr = GlobalFun.ObjPlusRide(this.selectData.basicatt, digitalNext);
            if (digital) {
                /**属性内容 */
                ...
                if (digitalNext) {
                    let nextProp = GlobalFun.ObjPlusOrMinus(nextAttr, this.selectData.gradeatt, (petServer.wLevel) * digitalNext);
            ...
            /**模型 */
            let modelId = GameCache.pet.getModelId(petServer.wStep, this.selectData.id);
